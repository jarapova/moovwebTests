...
feature 'TrueAutomation.IO capybara example' do
  scenario 'Annie Selke - Navigate to "Catalogs" page' do
    ...
    #find(:xpath, ta('annieselke:mainPage:companyCategory')).click
