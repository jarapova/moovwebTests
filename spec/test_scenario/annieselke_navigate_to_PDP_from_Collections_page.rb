...
feature 'TrueAutomation.IO capybara example' do
  scenario 'Annie Selke - Navigate to PDP from "Collections" page' do
    ...
    find(:xpath, ta('annieselke:mainPage:categoryCollections')).click
    ...
    find(:xpath, ta('annieselke:mainPage:subcategory:featuredCollections')).click

    #click to select "all collections" featured subcategory
    find(:xpath, ta('annieselke:mainPage:subcategory:allCollections', "(//a/li)[11]")).click
    #find(:xpath, "//li/div[text()='All Collections']").click
    #find(:xpath, ta('annieselke:mainPage:subcategory:allCollections')).click
    ...
    #find(:xpath, ta('annieselke:collactionsPage:lauraParkCollection')).click
    ...
    #find(:xpath, ta('annieselke:productPage:lauraCollectionsPillow')).click
