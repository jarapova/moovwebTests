...
feature 'TrueAutomation.IO capybara example' do
  scenario 'Annie Selke - Create account' do
    ...
    find(:xpath, ta(   'annieselke:mainPage:createAccount')).click
    ...
    find(:xpath, ta(   'annieselke:loginPage:firstName')).set('youre.example@gmail.com')
    ...
    find(:xpath, ta(   'annieselke:loginPage:checkPwd')).set('1234tesT')
