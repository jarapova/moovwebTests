...
feature 'TrueAutomation.IO capybara example' do
  scenario 'Annie Selke - edit account' do
    ...
    find(:xpath, ta('annieselke:loginPage:mobile:signInEmail')).set('julia.arapova@softesis.com')
    ...
    find(:xpath, ta('annieselke:loginPage:mobile:pass')).set('1234tesT')

    #click on login btn
    #find(:xpath, ta('annieselke:loginPage:mobile:loginBtn', "//button[text()='Login']")).click
    #find(:xpath, "//button[text()='Login']").click
    find(:xpath, ta('annieselke:loginPage:mobile:loginBtn')).click
    ...
    find(:xpath, ta('annieselke:loginPage:mobile:myAccount')).click
    sleep 4
