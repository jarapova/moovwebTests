...
feature 'TrueAutomation.IO capybara example' do
  scenario 'Annie Selke - Navigate to PDP from "No Results" page' do
    ...
    find(:xpath, ta('annieselke:mainPage:search')).click
    ...
    find(:xpath, ta('annieselke:searchPage:searchRequest')).set('84568y4thgjghd')
    ...
    find(:xpath, ta('annieselke:searchPage:searchBtn')).click
    ...
    find(:xpath, ta('annieselke:searchPage:product')).click
